	    ...
	    for (int i = -1; i <= 1; i++) {
	        for (int j = -1; j <= 1; j++) {
	            ...
	            if (nx >= 0 && nx < filas && ny >= 0 && ny < columnas) {
	                if (matriz_abajo[nx][ny] != null && !matriz_abajo[nx][ny].equals("+") && !matriz_abajo[nx][ny].matches("[0-9]")) {
	                    numero++;
	                }
	            }
	        }
...
//hacer dos matrizes una de arriba y otra abajo en la de arriba pondre diferentes simbolos para diferenciar los diferentes cuadrados,si esta descubierto o no
//si tiene un * el cuadrado sera de un color,si tiene un + sera de otro color y si tiene un _ sera que el cuadrado esta descubierto y muestra el cuadrado de la matriz de abajo
//si tiene | sera que tiene puesta una bandera encima del cuadrado indicando que el usuario cree que hay una bomba ahi 
//la matriz de abajo tendra una x si es una bomba si no tiene una bomba tendra estara null o si tiene alguna bomba cerca tendra un numero que son las bombas q tiene cerca